...
export const FILE_EXTENSIONS: Record<Exclude<FileCategory, 'All'>, string[]> = {
  ...
  Images: ['.jpg', '.jpeg', '.png', '.gif', '.bmp', '.webp', '.svg'], // هذا هو السطر الجديد
};
...
export const MOCK_FILES_DATA = [
  ...
  { name: 'Architecture_Plan.pdf', size: 1024 * 1024 * 4.2, date: '2024-04-01T15:30:00Z', path: 'D:\\Archive\\Project_X\\Architecture_Plan.pdf' },
  ...
  // تمت إضافة ملفين للصور للتجربة
  { name: 'Logo_Design.png', size: 1024 * 250, date: '2024-04-22T09:00:00Z', path: 'D:\\Design\\Assets\\Logo_Design.png' },
  { name: 'Family_Photo.jpg', size: 1024 * 1024 * 3.5, date: '2024-01-15T18:20:00Z', path: 'E:\\Media\\Pictures\\Family_Photo.jpg' },
];
